...
| { method: 'delete', path: '-/bots/{bot_id}', parts: 2, params: undefined, response: undefined }
...
| { method: 'post', path: `/channels/${string}/invites`, parts: 3, params: paths['/channels/{target}/invites']['post']['requestBody']['content']['application/json'], response: paths['/channels/{target}/invites']['post']['responses']['200']['content']['application/json'] }
| { method: 'post', path: '-/channels/{target}/invites', parts: 3, params: paths['/channels/{target}/invites']['post']['requestBody']['content']['application/json'], response: paths['/channels/{target}/invites']['post']['responses']['200']['content']['application/json'] }
...
| { method: 'delete', path: '-/channels/{group_id}/recipients/{member_id}', parts: 4, params: undefined, response: undefined }
| { method: 'post', path: `/channels/${string}/join_call`, parts: 3, params: paths['/channels/{target}/join_call']['post']['requestBody']['content']['application/json'], response: paths['/channels/{target}/join_call']['post']['responses']['200']['content']['application/json'] }
| { method: 'post', path: '-/channels/{target}/join_call', parts: 3, params: paths['/channels/{target}/join_call']['post']['requestBody']['content']['application/json'], response: paths['/channels/{target}/join_call']['post']['responses']['200']['content']['application/json'] }
| { method: 'put', path: `/channels/${string}/end_ring/${string}`, parts: 4, params: undefined, response: undefined }
| { method: 'put', path: '-/channels/{target}/end_ring/{target_user}', parts: 4, params: undefined, response: undefined }
...
| { method: 'post', path: `/channels/${string}/webhooks`, parts: 3, params: paths['/channels/{channel_id}/webhooks']['post']['requestBody']['content']['application/json'], response: paths['/channels/{channel_id}/webhooks']['post']['responses']['200']['content']['application/json'] }
| { method: 'post', path: '-/channels/{channel_id}/webhooks', parts: 3, params: paths['/channels/{channel_id}/webhooks']['post']['requestBody']['content']['application/json'], response: paths['/channels/{channel_id}/webhooks']['post']['responses']['200']['content']['application/json'] }
...
| { method: 'get', path: `/servers/${string}/members/${string}`, parts: 4, params: paths['/servers/{server_id}/members/{member_id}']['get']['parameters']['query'], response: paths['/servers/{server_id}/members/{member_id}']['get']['responses']['200']['content']['application/json'] }
| { method: 'get', path: '-/servers/{server_id}/members/{member_id}', parts: 4, params: paths['/servers/{server_id}/members/{member_id}']['get']['parameters']['query'], response: paths['/servers/{server_id}/members/{member_id}']['get']['responses']['200']['content']['application/json'] }
| { method: 'delete', path: `/servers/${string}/members/${string}`, parts: 4, params: undefined, response: undefined }
| { method: 'delete', path: '-/servers/{server_id}/members/{member_id}', parts: 4, params: undefined, response: undefined }
| { method: 'patch', path: `/servers/${string}/members/${string}`, parts: 4, params: paths['/servers/{server_id}/members/{member_id}']['patch']['requestBody']['content']['application/json'], response: paths['/servers/{server_id}/members/{member_id}']['patch']['responses']['200']['content']['application/json'] }
| { method: 'patch', path: '-/servers/{server_id}/members/{member_id}', parts: 4, params: paths['/servers/{server_id}/members/{member_id}']['patch']['requestBody']['content']['application/json'], response: paths['/servers/{server_id}/members/{member_id}']['patch']['responses']['200']['content']['application/json'] }
...
| { method: 'put', path: `/custom/emoji/${string}`, parts: 3, params: paths['/custom/emoji/{emoji_id}']['put']['requestBody']['content']['application/json'], response: paths['/custom/emoji/{emoji_id}']['put']['responses']['200']['content']['application/json'] }
